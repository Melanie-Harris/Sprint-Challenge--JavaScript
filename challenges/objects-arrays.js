...
for (let i = 0; i < graduates.length; i++) {
  const schools = graduates[i].university;
...
for (let i = 0; i < graduates.length; i++) {
  let grads = graduates[i].first_name + " " + graduates[i].email;
  contactInfo.push(grads);
...
//TRIED TO SOLVE THIS BOTH WAYS AND STILL GOT NO RESULTS BACK. I LOOKED ABOVE, NO UNVERSITIES HAVE "UNI" IN NAME
// HOWEVER SOME HAVE THE WORD UNIVERSITY
const uni = [];
...
// const uni = graduates.filter(function (grads) {
//     return grads.university === "Uni";
// });
// console.log(uni);
